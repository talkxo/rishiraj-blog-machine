---
layout: post
title: "On software, made just for you"
date: 2026-05-28 23:00:00 +0530
description: "AI didn't just make coding easier. It made personal software possible — tools built for one person, fitted to one context, solving one specific problem. I've been living this for a year."
categories: [tech]
tags: [ai, software, vibe-coding, tools, productivity]
---

There's an article on The Verge that crystallised something I'd been feeling but hadn't quite found the words for. They call it the [personal software revolution](https://www.theverge.com/tech/928905/vibe-code-personal-software-revolution). The idea is simple: AI has made it possible for anyone to build software that fits them exactly — not software built for a million users, watered down to offend no one, wrapped in a subscription you half-use.
...
The gap is closing. The cost of fit is dropping. And for people willing to spend an afternoon describing what they want instead of browsing what exists — the options are genuinely different now.
